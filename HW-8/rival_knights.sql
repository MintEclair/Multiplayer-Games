...
--
-- Host: localhost    Database: rival_knights
-- ------------------------------------------------------
...
CREATE TABLE `playerdata` (
  `winRate` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `playerdata` VALUES (1,5);
...
INSERT INTO `playerinfo` VALUES (3,'SmittyJenkins');
...
-- Dump completed on 2025-03-24 16:56:01
